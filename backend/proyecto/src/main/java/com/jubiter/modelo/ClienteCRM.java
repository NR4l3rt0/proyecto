...
public class ClienteCRM extends Persona{
	...
	public ClienteCRM(String nombre, String apellidos, String tfno, String email,
						String sexo, String localidad, String estadoCivil, String estudio,
						String ocupacion, String hobby, LocalDate fechaNacimiento, boolean familiaNumerosa, 
						Integer nroSocio, LocalDate fechaBaja, boolean encuestaHecha, String comentario) {
		super(nombre, apellidos, tfno, email, sexo,
			  localidad, estadoCivil, estudio, ocupacion,
			  hobby, fechaNacimiento, familiaNumerosa);
	...
	public String toString() {
		return "ClienteCRM [nroSocio=" + nroSocio + ", fechaAlta=" + fechaAlta + ", fechaBaja=" + fechaBaja
				...
				+ ", hobby=" + getHobby() + ", fechaNacimiento=" + getFechaNacimiento() + ", familiaNumerosa="
				+ isFamiliaNumerosa();
	}
